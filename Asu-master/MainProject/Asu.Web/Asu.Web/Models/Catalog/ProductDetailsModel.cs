...
namespace Asu.Web.Models.Catalog
{
    public partial class ProductDetailsModel : BaseNopEntityModel
    {
        public ProductDetailsModel()
        {
            ...
            ProductReviewOverview = new CustomProductReviewOverviewModel();
            ...
            this.CompetitorPrices = new List<CompetitorPrice>();
            this.VendorQtyPrices = new List<VendorProductCost>();
            this.ProductVehicles = new List<ProductVehicleModel>();
            this.ProductFitmentGroupModels = new List<ProductFitmentGroupModel>();
        ...
        public IList<ProductVehicleModel> ProductVehicles { get; set; }

        public IList<ProductFitmentGroupModel> ProductFitmentGroupModels { get; set; }

        public CustomProductOverviewModel ProductExtra { get; set; }
        ...
        public partial class ProductPriceModel : BaseNopModel
        {
            ...
            public decimal PriceTierValue { get; set; }
        ...
        public List<VendorProductCost> VendorQtyPrices { get; set; }
        public bool IsUniversal { get; set; }
        public bool IsVehicleSpecific { get; set; }
        public bool? IsVehicleFits { get; set; }
