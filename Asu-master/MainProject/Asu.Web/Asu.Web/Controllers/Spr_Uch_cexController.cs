...
{
    public class Spr_Uch_cexController : Controller
    {
        ...
        {
            var model = db.Spr_uch_cex;
            return PartialView("_GridView2Partial", model.ToList());
        }

        [HttpPost, ValidateInput(false)]
        public ActionResult GridView2PartialAddNew(Asu.Web.Models.Spr_uch_cex item)
        {
            var model = db.Spr_uch_cex;
        ...
        [HttpPost, ValidateInput(false)]
        public ActionResult GridView2PartialUpdate(Asu.Web.Models.Spr_uch_cex item)
        {
            var model = db.Spr_uch_cex;
            if (ModelState.IsValid)
            {
