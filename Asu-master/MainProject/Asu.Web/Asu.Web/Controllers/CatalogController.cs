    ...
    public partial class CatalogController : BasePublicController
    {
            ...
            bool forceRedirectionAfterAddingToCart = false)
        {
            return this.PrepareProductOverviewModels(this._workContext,
                this._storeContext, this._categoryService, this._productService, this._specificationAttributeService,
                this._priceCalculationService, this._priceFormatter, this._permissionService,
                this._localizationService, this._taxService, this._currencyService,
                this._pictureService, this._webHelper, this._cacheManager,
                this._catalogSettings, this._mediaSettings, products,
