...
using Asu.Core.Domain.Configuration;
...
using Asu.Core.Events;
using Asu.Core.Infrastructure;
using Asu.Services.Events;

namespace Asu.Web.Infrastructure.Cache
{
    /// <summary>
        ...
        IConsumer<EntityUpdated<ShoppingCartItem>>
    {
        ...
        /// {2} : results number
        /// </remarks>
        public const string PRODUCTS_ALSO_PURCHASED_LIMITED_IDS_KEY = "Nop.pres.alsopuchased-{0}-{1}";
        ...
        /// {2} : results number
        /// </remarks>
        public const string PRODUCTS_RECOMENDATION_DISCOUNTS_IDS_KEY = "Nop.pres.recommend.discount-{0}-{1}";
        #endregion
        ...
        /// <summary>
        /// Key for manufacturer banner
        /// {0} : manufacturer id
        /// {1} : Banner type - Desktop/Mobile
        /// </summary>
        public const string MANUFACTURER_BANNERPICTURE_MODEL_KEY = "Nop.pres.manufacturer.picture-banner-{0}-{1}";
