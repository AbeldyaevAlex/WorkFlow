...
// Type: OffAmazonPaymentsService.Model.Constraints
...
namespace OffAmazonPaymentsService.Model
{
  ...
  public class Constraints
  {
    ...
    {
      foreach (Constraint constraint in list)
        this.Constraint.Add(constraint);
      return this;
    }

    public bool IsSetConstraint()
    {
    ...
    protected internal string ToXMLFragment()
    {
      ...
      foreach (Constraint constraint in this.Constraint)
      {
        stringBuilder.Append("<Constraint>");
        stringBuilder.Append(constraint.ToXMLFragment());
        stringBuilder.Append("</Constraint>");
      }
