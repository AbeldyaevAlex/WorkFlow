...
// Type: OffAmazonPaymentsService.Model.RefundResponse
...
namespace OffAmazonPaymentsService.Model
{
  ...
  public class RefundResponse
  {
    ...
    [XmlElement(ElementName = "RefundResult")]
    ...
    public string ToXML()
    {
      ...
      stringBuilder.Append("<RefundResponse xmlns=\"http://mws.amazonservices.com/schema/OffAmazonPayments/2013-01-01\">");
      if (this.IsSetRefundResult())
      {
        RefundResult refundResult = this.RefundResult;
        stringBuilder.Append("<RefundResult>");
        stringBuilder.Append(refundResult.ToXMLFragment());
        stringBuilder.Append("</RefundResult>");
      }
      ...
      stringBuilder.Append("</RefundResponse>");
