...
namespace Asu.Core
{
    ...
    public partial class CommonHelper
    {
        ...
        public static TypeConverter GetNopCustomTypeConverter(Type type)
        {
            ...
            //{
            //    return new WarrantyTypeConverter();
            //}
        ...
        /// <summary>
        /// Removes option-based characters from input string
        /// </summary>
        public static string Sanitize(string source, SanitizeOption option)
        {
            switch (option)
            {
                case SanitizeOption.NonAplhanumericTrim:
                    source = source.Trim(source.Where(c => !char.IsLetterOrDigit(c)).ToArray());
                    break;
                default:
                    source = source.Trim();
                    break;
