...
namespace Asu.Core.Domain.Discounts
{
    ...
    public partial class Discount : BaseEntity
    {
        ...
        #region WC
        private ICollection<Manufacturer> _appliedToBrands;
        #endregion
        ...
        /// Gets or sets the categories
        /// </summary>
        public virtual ICollection<Manufacturer> AppliedToBrands
        {
            get { return _appliedToBrands ?? (_appliedToBrands = new List<Manufacturer>()); }
            protected set { _appliedToBrands = value; }
        }
