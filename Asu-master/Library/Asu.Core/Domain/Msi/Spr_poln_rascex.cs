...
{
    public partial class Spr_poln_rascex : BaseEntity
    {
        public int RascizdId { get; set; }

        public int? Cp1_Id { get; set; }

        public int? Cp2_Id { get; set; }

        public int? Cp3_Id { get; set; }
