...
namespace Asu.Core.Domain.Orders
{
    ...
    public partial class Order : BaseEntity
    {
        ...
        private ICollection<SignifydDeviceFingerprints> _signifydDeviceFingerprints;
        ...
        /// <summary>
        /// Gets or sets order sessions
        /// </summary>
        public virtual ICollection<SignifydDeviceFingerprints> SignifydDeviceFingerprints
        {
            get { return _signifydDeviceFingerprints ?? (_signifydDeviceFingerprints = new List<SignifydDeviceFingerprints>()); }
            protected set { _signifydDeviceFingerprints = value; }
        }
        ...
        public virtual AmazonPaymentAdvanced AmazonPaymentAdvanced_asFirst { get; set; }
        public virtual AmazonPaymentAdvanced AmazonPaymentAdvanced_asSecond { get; set; }
