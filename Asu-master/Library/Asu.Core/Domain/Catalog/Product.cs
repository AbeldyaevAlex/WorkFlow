...
namespace Asu.Core.Domain.Catalog
{
    ...
    public partial class Product : BaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported
    {
        ...
        private ICollection<ProductRecommendation> _productRecommendation;

        #region WC

        private ICollection<FakeReview> _productFakeReviews;
        private ICollection<VendorProductCost> _productVendorQtyPrices;
        private ICollection<CompetitorPrice> _competitorPrices;
        private ICollection<ProductVehicle> _productVehicles;
        private ICollection<ProductVehicleFitment> _productVehicleFitments;

        #endregion

        #region WCS

        private ICollection<ProductGroupClubPrice> _productGroupClubPrices;
        ...
        /// Gets or sets the tier prices
        /// </summary>
        public virtual ICollection<ProductGroupClubPrice> ProductGroupClubPrices
        {
            get { return _productGroupClubPrices ?? (_productGroupClubPrices = new List<ProductGroupClubPrice>()); }
            protected set { _productGroupClubPrices = value; }
        }
        ...
        {
            get { return _productRecommendation ?? (_productRecommendation = new List<ProductRecommendation>()); }
            protected set { _productRecommendation = value; }
        }

        #region WC

        public virtual ICollection<ProductVehicle> ProductVehicles
        {
            get { return _productVehicles ?? (_productVehicles = new List<ProductVehicle>()); }
            protected set { _productVehicles = value; }
        }

        public virtual ICollection<ProductVehicleFitment> ProductVehicleFitments
        {
            get { return _productVehicleFitments ?? (_productVehicleFitments = new List<ProductVehicleFitment>()); }
            protected set { _productVehicleFitments = value; }
        }

        /// <summary>
        /// Gets or sets the collection of product fake reviews
        /// </summary>
        public virtual ICollection<FakeReview> FakeReviews
        {
            get { return _productFakeReviews ?? (_productFakeReviews = new List<FakeReview>()); }
            protected set { _productFakeReviews = value; }
        }

        public virtual ICollection<VendorProductCost> VendorQtyPrices
        {
            get { return _productVendorQtyPrices ?? (_productVendorQtyPrices = new List<VendorProductCost>()); }
            protected set { _productVendorQtyPrices = value; }
        }

        public virtual ICollection<CompetitorPrice> CompetitorPrices
        {
            get { return _competitorPrices ?? (_competitorPrices = new List<CompetitorPrice>()); }
            protected set { _competitorPrices = value; }
        }
