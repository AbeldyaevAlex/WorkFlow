namespace Asu.Services.Payments
{
    ...
    public enum PaymentMethodType
    {
        ...
        #region WC
        /// <summary>
        /// A customer is redirected to a third-party site in order to complete the payment but this payment method use own checkout process
        /// </summary>
        ExternalCheckoutProcess = 30,
        #endregion
    }
}
