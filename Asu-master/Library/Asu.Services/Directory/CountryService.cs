...
namespace Asu.Services.Directory
{
    /// <summary>
    /// Country service
    /// </summary>
    public partial class CountryService : ICountryService
    {
        ...
        {
            // only US shipping allowed
            return GetAllCountries(showHidden).Where(c => c.AllowsShipping && c.Id == ConstantStorage.US).ToList(); 
        }
        ...
        /// <returns>Country</returns>
        public virtual Country GetCountryByName(string name)
        {
            var query = from c in _countryRepository.TableNoTracking
                        where c.Name == name
                        select c;
