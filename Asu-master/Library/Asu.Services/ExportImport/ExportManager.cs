...
namespace Asu.Services.ExportImport
{
    ...
    public partial class ExportManager : IExportManager
    {
        ...
        public virtual string ExportProductsToXml(IList<Product> products)
        {
            ...
            foreach (var product in products)
            {
                ...
                xmlWriter.WriteElementString("IsFreeShipping", null, this.shippingService.IsFreeShipping(product, storeId).ToString());
                ...
                xmlWriter.WriteElementString("ManageInventoryMethodId", null, this.productService.GetInventoryManageMethod(product, this.storeContext.CurrentStore.Id).ToString());
                ...
                xmlWriter.WriteElementString("Price", null, this.priceCalculationService.GetFinalPrice(product, this.workContext.CurrentCustomer).ToString());
        ...
        public virtual void ExportProductsToXlsx(Stream stream, IList<Product> products)
        {
            ...
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                foreach (var p in products)
                {
                    ...
                    worksheet.Cells[row, col].Value = this.shippingService.IsFreeShipping(p, storeId);
                    col++;
                    ...
                    worksheet.Cells[row, col].Value = (int)this.productService.GetInventoryManageMethod(p, this.storeContext.CurrentStore.Id);
                    col++;
                    ...
                    worksheet.Cells[row, col].Value = this.priceCalculationService.GetFinalPrice(p, this.workContext.CurrentCustomer);
                    col++;
