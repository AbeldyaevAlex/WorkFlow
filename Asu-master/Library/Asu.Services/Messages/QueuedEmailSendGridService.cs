...
{
    public partial class QueuedEmailSendGridService : IQueuedEmailSendGridService
    {
        private readonly IRepository<QueuedEmailSendGrid> _queuedEmailRepository;
        ...
        public QueuedEmailSendGridService(IRepository<QueuedEmailSendGrid> queuedEmailRepository,
        ...
        public virtual void InsertQueuedEmail(QueuedEmailSendGrid queuedEmail)
        {
            if (queuedEmail == null)
        ...
        /// </summary>
        /// <param name="queuedEmail">Queued email</param>
        public virtual void UpdateQueuedEmail(QueuedEmailSendGrid queuedEmail)
        {
            if (queuedEmail == null)
                throw new ArgumentNullException("queuedEmail");
        ...
        /// </summary>
        /// <param name="queuedEmail">Queued email</param>
        public virtual void DeleteQueuedEmail(QueuedEmailSendGrid queuedEmail)
        {
            if (queuedEmail == null)
                throw new ArgumentNullException("queuedEmail");
        ...
        public virtual QueuedEmailSendGrid GetQueuedEmailById(int queuedEmailId)
        {
            if (queuedEmailId == 0)
                return null;
        ...
        public virtual IList<QueuedEmailSendGrid> GetQueuedEmailsByIds(int[] queuedEmailIds)
        {
            if (queuedEmailIds == null || queuedEmailIds.Length == 0)
                return new List<QueuedEmailSendGrid>();
            ...
            var sortedQueuedEmails = new List<QueuedEmailSendGrid>();
        ...
        public virtual IPagedList<QueuedEmailSendGrid> SearchEmails(string fromEmail,
            ...
            bool loadNewest, int pageIndex, int pageSize)
        {
            ...
            query = loadNewest ? 
                ((IOrderedQueryable<QueuedEmailSendGrid>)query).ThenByDescending(qe => qe.CreatedOnUtc) :
                ((IOrderedQueryable<QueuedEmailSendGrid>)query).ThenBy(qe => qe.CreatedOnUtc);

            var queuedEmails = new PagedList<QueuedEmailSendGrid>(query, pageIndex, pageSize);
            return queuedEmails;
        }
        ...
        public virtual void DeleteAllEmails()
        {
            if (_commonSettings.UseStoredProceduresIfSupported && _dataProvider.StoredProceduredSupported)
            {
                ...
                string queuedEmailTableName = _dbContext.GetTableName<QueuedEmailSendGrid>();
