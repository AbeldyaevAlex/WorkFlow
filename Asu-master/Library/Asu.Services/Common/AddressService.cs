...
namespace Asu.Services.Common
{
    ...
    public partial class AddressService : IAddressService
    {
        ...
        public void OverrideZipCode(Address address)
        {
            if (address.Country.Id == ConstantStorage.US && address.ZipPostalCode.Length > 5)
            {
                address.ZipPostalCode = address.ZipPostalCode.Substring(0, 5);
