...
namespace Asu.Services.Catalog
{
    ...
    public partial interface ISpecificationAttributeService
    {
        ...
        /// Gets a specification attribute
        /// </summary>
        /// <param name="names">The specification attribute names</param>
        /// <returns>Specification attribute</returns>
        IEnumerable<SpecificationAttribute> GetSpecificationAttributes(params string[] names);
        ...
        /// <summary>
        /// Gets a product specification attributes mapping collection
        /// </summary>
        /// <param name="productIds">Products identifiers</param>
        /// <returns>Product specification attribute mapping collection</returns>
        IList<ProductSpecificationAttribute> GetProductSpecificationAttributesByProductIds(int[] productIds);
        ...
        IList<SpecificationAttributeOption> GetSpecificationAttributeOptionsBySpecificationAttributeIds(int[] specificationAttributeIds);

        #endregion

        IEnumerable<SpecificationAttributeDescriptor> GetSpecificationAttributeDescriptions(int attributeId);
    }
}
