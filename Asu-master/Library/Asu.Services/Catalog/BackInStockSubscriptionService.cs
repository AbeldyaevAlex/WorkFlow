...
namespace Asu.Services.Catalog
{
    ...
    public partial class BackInStockSubscriptionService : IBackInStockSubscriptionService
    {
        ...
        public int SendBackInStockNotification(BackInStockSubscription productSubscription)
        {
            return _workflowMessageService.SendBackInStockNotification(productSubscription, 0);
        }
