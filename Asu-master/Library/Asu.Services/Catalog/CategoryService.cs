...
namespace Asu.Services.Catalog
{
    ...
    public partial class CategoryService : ICategoryService
    {
        ...
        protected readonly IRepository<ManufacturerPiesCategory> manufacturerPiesCategoryRepository;
        ...
        public CategoryService(ICacheManager cacheManager,
            ...
            IRepository<ManufacturerPiesCategory> manufacturerPiesCategoryRepository)
        {
            ...
            this.manufacturerPiesCategoryRepository = manufacturerPiesCategoryRepository;
        }
        ...
        /// <summary>
        /// WC. Select categories by Id's list
        /// </summary>
        /// <param name="categoryIds">Categories Id's list</param>
        /// <returns>Categories list</returns>
        public IList<Category> GetCategoriesByIdList(IList<int> categoryIds)
        {
            if (categoryIds == null)
        ...
        /// <summary>
        /// WC. Select only PIES categories by manufacturerId
        /// </summary>
        /// <param name="manufacturerId">Manufacturer id</param>
        /// <returns>Categories list</returns>
        public IList<Category> GetPiesCategoriesByManufacturerId(int manufacturerId)
        {
            if (manufacturerId == 0)
            {
                return null;
            ...
            var query = from a in this._categoryRepository.Table
                        join b in this.manufacturerPiesCategoryRepository.Table on a.Id equals b.CategoryId
