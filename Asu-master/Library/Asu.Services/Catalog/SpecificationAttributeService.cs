...
namespace Asu.Services.Catalog
{
    ...
    public partial class SpecificationAttributeService : ISpecificationAttributeService
    {
        ...
        private readonly IRepository<SpecificationAttributeDescriptor> productSpecificationAttributeDescriptionRepository;
        ...
        public SpecificationAttributeService(ICacheManager cacheManager,
            ...
            IRepository<SpecificationAttributeDescriptor> productSpecificationAttributeDescriptionRepository)
        {
            ...
            this.productSpecificationAttributeDescriptionRepository = productSpecificationAttributeDescriptionRepository;
        }
        ...
        public IEnumerable<SpecificationAttribute> GetSpecificationAttributes(params string[] names)
        {
            if (names == null)
            {
            ...
            var query = from a in this._specificationAttributeRepository.Table
                        join b in names on a.Name equals b
                        orderby a.Name
                        select a;
        ...
        public IEnumerable<SpecificationAttributeDescriptor> GetSpecificationAttributeDescriptions(int attributeId)
        {
            var query = from a in this.productSpecificationAttributeDescriptionRepository.TableNoTracking
        ...
        public IList<SpecificationAttributeOption> GetSpecificationAttributeOptionsBySpecificationAttributeIds(int[] specificationAttributeIds)
        {
            ...
            var query = this._specificationAttributeRepository.Table
                            .Join(specificationAttributeIds, a => a.Id, b => b, (a, b) => a)
                            .SelectMany(m => m.SpecificationAttributeOptions);

            var specificationAttributeOptions = query.Distinct().ToList();
            //sort by passed identifiers
            //var sortedSpecificationAttributeOptions = new List<SpecificationAttributeOption>();
            //foreach (int id in specificationAttributeOptionIds)
            //{
        ...
        /// Gets a product specification attribute mapping collection
        /// </summary>
        /// <param name="productIds">Products identifiers</param>
        /// <returns>Product specification attribute mapping collection</returns>
        public virtual IList<ProductSpecificationAttribute> GetProductSpecificationAttributesByProductIds(int[] productIds)
        {
            
            //string key = string.Format(PRODUCTSPECIFICATIONATTRIBUTE_ALLBYPRODUCTID_KEY);
