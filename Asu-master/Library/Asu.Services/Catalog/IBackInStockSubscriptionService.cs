...
namespace Asu.Services.Catalog
{
    ...
    public partial interface IBackInStockSubscriptionService
    {
        ...
        /// <summary>
        /// Send SendGrid notification to subscribers
        /// </summary>
        /// <param name="productSubscription">Subscription</param>
        /// <returns></returns>
        int SendBackInStockNotification(BackInStockSubscription productSubscription);
    }
}
