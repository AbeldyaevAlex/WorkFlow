...
namespace Asu.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        IQueryable<int> GetProductIds(bool showHidden = false);
        ...
        IList<Product> GetProductsByIds(int[] productIds, bool sortByCollection);

        IQueryable<Product> GetProductsByIds(int[] productIds);
        ...
        /// <returns>Products</returns>
        IPagedList<Product> AdvanceSearchProducts(int pageIndex = 0,
             int pageSize = int.MaxValue,
        ...
        /// <summary>
        /// Gets ProductGroupClubPrice
        /// </summary>
        /// <param name="ProductGroupClubPriceId">ProductGroupClubPrice identifier</param>
        /// <returns>ProductGroupClubPrice</returns>
        ProductGroupClubPrice GetProductGroupClubPriceById(int ProductId);
        ...
        ManageInventoryMethod GetInventoryManageMethod(Product product, int storeId);

        ManageInventoryMethod GetInventoryManageMethod(int productId, ManageInventoryMethod manageInventoryMethod, int storeId);

        int GetOutstockOrderAvgShipLeadTime(int productId, int channelId);

        IList<Product> GetBestSellerProducts(int takeCount, bool showHidden = false);
    }
}
