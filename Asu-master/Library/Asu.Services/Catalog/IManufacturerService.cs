...
namespace Asu.Services.Catalog
{
    ...
    public partial interface IManufacturerService
    {
        ...
        PagedList<Manufacturer> GetAllManufacturers(string manufacturerName = "",
            int pageIndex = 0,
        ...
        /// <summary>
        /// WC. Select manufacturers by Id's list
        /// </summary>
        /// <param name="manufacturerIds">Manufacturers Id's list</param>
        /// <returns>Manufacturers list</returns>
        IList<Manufacturer> GetManufacturersByIdList(IList<int> manufacturerIds);
