...
namespace Asu.Services.Catalog
{
    ...
    public partial class ManufacturerService : IManufacturerService
    {
        ...
        private const string ALL_MANUFACTURERS_KEY = "WC.Manufacturers.All";
            ...
            IProductService prouctService)
        {
            ...
            this._productService = prouctService;
        }
        #endregion
        ...
        public virtual PagedList<Manufacturer> GetAllManufacturers(string manufacturerName = "",
            int pageIndex = 0,
            int pageSize = int.MaxValue, 
            bool showHidden = false,
            bool showManufacturersWithProducts = false)
        {
            var query = this._manufacturerRepository.TableNoTracking.Where(m => !m.Deleted);
            if (!showHidden)
            {
            ...
            if (showManufacturersWithProducts)
            {
                var productIdsCache = this._productService.GetProductIds();

                var manufacturers = query
                        .Join(this._productManufacturerRepository.TableNoTracking, a => a.Id, b => b.ManufacturerId, (a, b) => new { Manufacturer = a, ProductManufacturer = b })
                        .Join(productIdsCache, b => b.ProductManufacturer.ProductId, c => c, (b, c) => new { b.Manufacturer })
        ...
        public IList<Manufacturer> GetManufacturersByIdList(IList<int> manufacturerIds)
        {
