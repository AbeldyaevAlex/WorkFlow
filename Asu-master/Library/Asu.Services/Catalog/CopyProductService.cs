    ...
    public partial class CopyProductService : ICopyProductService
    {
            ...
            bool isPublished = true, bool copyImages = true, bool copyAssociatedProducts = true)
        {
            ...
            var productCopy = new Product
            {
                ...
                IsFreeShipping = shippingService.IsFreeShipping(product, storeId),
                ShipSeparately = product.ShipSeparately,
                AdditionalShippingCharge = product.AdditionalShippingCharge,
                DeliveryDateId = product.DeliveryDateId,
                IsTaxExempt = product.IsTaxExempt,
                TaxCategoryId = product.TaxCategoryId,
                ManageInventoryMethod = this._productService.GetInventoryManageMethod(product, this.storeContext.CurrentStore.Id),
