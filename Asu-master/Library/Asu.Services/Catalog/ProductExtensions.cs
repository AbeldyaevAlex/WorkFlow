...
namespace Asu.Services.Catalog
{
    ...
    public static class ProductExtensions
    {
        ...
        public static string FormatStockMessage(this Product product, ILocalizationService localizationService)
        {
            ...
            if (productService.GetInventoryManageMethod(product, storeId) != ManageInventoryMethod.ManageStock)
                return stockMessage;
            ...
            out string sku, out string manufacturerPartNumber, out string gtin)
        {
            ...
            var storeId = EngineContext.Current.Resolve<IStoreContext>().CurrentStore.Id;
            var productService = EngineContext.Current.Resolve<IProductService>();
            if (productService.GetInventoryManageMethod(product, storeId) == ManageInventoryMethod.ManageStockByAttributes)
            {
