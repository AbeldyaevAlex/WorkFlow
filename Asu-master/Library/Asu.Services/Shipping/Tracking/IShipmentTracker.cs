...
namespace Asu.Services.Shipping.Tracking
{
    ...
    public partial interface IShipmentTracker
    {
        ...
        // WC.
        IList<ShipmentStatusEvent> GetShipmentEvents(string trackingNumber, out DateTime? shippedOn, out DateTime? deliveredOn, out DateTime? estimateDelivery, out string carrierName);
    }
}
