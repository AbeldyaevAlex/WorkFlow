...
namespace Asu.Services.Shipping.Tracking
{
    /// <summary>
    ...
    public partial class GeneralShipmentTracker : IShipmentTracker
    {
        ...
        public IList<ShipmentStatusEvent> GetShipmentEvents(string trackingNumber, out DateTime? shippedOn, out DateTime? deliveredOn, out DateTime? estimateDelivery, out string carrierName)
        {
            shippedOn = null;
            deliveredOn = null;
