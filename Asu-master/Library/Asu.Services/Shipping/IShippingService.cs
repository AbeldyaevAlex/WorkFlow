...
namespace Asu.Services.Shipping
{
    ...
    public partial interface IShippingService
    {
        ...
        /// <summary>
        /// Inserts original shipping rate
        /// </summary>
        /// <param name="rate">Original rate</param>
        void InsertOriginalShippingRate(OriginalShippingRate rate);
        ...
        /// <summary>
        /// Gets State/Province abbreviation from it's zip code
        /// </summary>
        /// <param name="zipCode">Zip code of state/province</param>
        /// <returns>State/Province abbreviation</returns>
        string GetStateProvinceByZipCode(string zipCode);

        /// <summary>
        /// Gets State/Province Id from it's zip code
        /// </summary>
        /// <param name="zipCode">Zip code of state/province</param>
        /// <returns>State/Province abbreviation</returns>
        int GetStateProvinceIdByZipCode(string zipCode, int countryId);

        string GetCityByZipCode(string zipCode);

        string GetStateAbbreviationByZipCode(string zipCode);

        bool IsFreeShipping(Product product, int storeId);
    }
}
