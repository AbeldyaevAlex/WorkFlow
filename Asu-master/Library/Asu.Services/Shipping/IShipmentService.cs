...
namespace Asu.Services.Shipping
{
    ...
    public partial interface IShipmentService
    {
        ...
        /// </summary>
        /// <param name="id">Shipping service id</param>
        string GetCarrierName(int id);

        RmaShipment GetShipment(string tracking, int rmaId);

        IList<Core.Domain.Returns.ShippingService> GetAllCarriers();

        IList<RmaShipment> GetShipments(int rmaId);
        ...
        string GetCarrierUrl(int shipmentId);

        string GetCarrierUrl(int id, string tarcking);
        ...
        /// Inserts a shipment
        /// </summary>
        /// <param name="shipment">RMA shipment</param>
        ...
        /// </summary>
        /// <param name="shipment">RMA shipment</param>
        void InsertShipment(RmaShipment shipment);
        ...
        /// <returns>CRM shipment</returns>
        CrmShipment GetCrmShipment(int id);
        ...
        /// </summary>
        /// <param name="shipmentItem">RMA shipment item</param>
        ...
        /// </summary>
        /// <param name="shipmentItem">RMA shipment item</param>
        void InsertShipmentItem(RmaShipmentItem shipmentItem);
