...
namespace Asu.Services.Media
{
    ...
    public partial interface IPictureService
    {
        ...
        /// <summary>
        /// Get a product additional image name
        /// </summary>
        ...
        IQueryable<Picture> GetPicturesByIds(int[] pictureIds);
        ...
        string GetWidthHeightDefaultPictureUrl(int maxWidth = 0, int maxHeight = 0,
            PictureType defaultPictureType = PictureType.Entity,
            string storeLocation = null);

        string GetWidthHeightPictureUrl(int pictureId,
            int maxWidth = 0,
            int maxHeight = 0,
            bool showDefaultPicture = true,
            string storeLocation = null,
            PictureType defaultPictureType = PictureType.Entity,
            bool useSeoName = true);

        string GetWidthHeightPictureUrl(Picture picture,
            int maxWidth = 0,
            int maxHeight = 0,
            bool showDefaultPicture = true,
            string storeLocation = null,
