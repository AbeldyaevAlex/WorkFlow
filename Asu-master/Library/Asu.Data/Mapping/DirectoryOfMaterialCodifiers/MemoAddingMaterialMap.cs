...
{
    public partial class MemoAddingMaterialMap : NopEntityTypeConfiguration<MemoAddingMaterialCode>
    {
        public MemoAddingMaterialMap()
        {
            this.ToTable("MemoAddingMaterialCode");
            this.HasKey(m => m.Id);
