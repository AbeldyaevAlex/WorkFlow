    ...
    public partial class OrderMap : NopEntityTypeConfiguration<Order>
    {
        public OrderMap()
        {
            ...
            this.HasOptional(o => o.ShippingAddress)
                ...
                .WillCascadeOnDelete(false);
            this.HasOptional(o => o.AmazonPaymentAdvanced_asFirst)
                .WithOptionalPrincipal(apa => apa.Order)
                .WillCascadeOnDelete(false);
            this.HasOptional(o => o.AmazonPaymentAdvanced_asSecond)
                .WithOptionalPrincipal(apa => apa.SecondOrder)
                .WillCascadeOnDelete(false);
        }
    }
}