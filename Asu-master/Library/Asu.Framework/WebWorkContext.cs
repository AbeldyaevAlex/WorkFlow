...
namespace Asu.Framework
{
    ...
    public partial class WebWorkContext : IWorkContext
    {
        ...
        private const string BotProtectionCookieName = "cfabr";
        private const string BotProtectionCookieValue = "6647bba8-c211-462a-bfae-7b8ac07cf32a";
        ...
        protected virtual void SetBotProtectionCookie()
        {
            if (this._httpContext != null && this._httpContext.Response != null)
            {
                var cookie = new HttpCookie(BotProtectionCookieName)
                {
                    HttpOnly = true,
                    Value = BotProtectionCookieValue,
                    Expires = DateTime.Now.AddDays(1),
                };

                this._httpContext.Response.Cookies.Remove(BotProtectionCookieName);
        ...
        public virtual Customer CurrentCustomer
        {
            get
            {
                ...
                //    {
                //        customer = this._customerService.GetCustomerBySystemName(SystemCustomerNames.ArrHealthyCheck);
                //    }
                //}
